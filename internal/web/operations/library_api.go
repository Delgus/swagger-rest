...
func NewLibraryAPI(spec *loads.Document) *LibraryAPI {
	return &LibraryAPI{
		...
		DeleteBooksBookIDHandler: DeleteBooksBookIDHandlerFunc(func(params DeleteBooksBookIDParams) middleware.Responder {
			return middleware.NotImplemented("operation DeleteBooksBookID has not yet been implemented")
		}),
		...
		GetBooksBookIDHandler: GetBooksBookIDHandlerFunc(func(params GetBooksBookIDParams) middleware.Responder {
			return middleware.NotImplemented("operation GetBooksBookID has not yet been implemented")
		}),
		...
		PutBooksHandler: PutBooksHandlerFunc(func(params PutBooksParams) middleware.Responder {
			return middleware.NotImplemented("operation PutBooks has not yet been implemented")
		}),
	}
}
...
type LibraryAPI struct {
	...
	// DeleteBooksBookIDHandler sets the operation handler for the delete books book ID operation
	DeleteBooksBookIDHandler DeleteBooksBookIDHandler
	// GetBooksHandler sets the operation handler for the get books operation
	GetBooksHandler GetBooksHandler
	// GetBooksBookIDHandler sets the operation handler for the get books book ID operation
	GetBooksBookIDHandler GetBooksBookIDHandler
	// PostBooksHandler sets the operation handler for the post books operation
	PostBooksHandler PostBooksHandler
	// PutBooksHandler sets the operation handler for the put books operation
	PutBooksHandler PutBooksHandler
...
func (o *LibraryAPI) Validate() error {
	...
	if o.DeleteBooksBookIDHandler == nil {
		unregistered = append(unregistered, "DeleteBooksBookIDHandler")
	}
	...
	if o.GetBooksBookIDHandler == nil {
		unregistered = append(unregistered, "GetBooksBookIDHandler")
	}
	...
	if o.PutBooksHandler == nil {
		unregistered = append(unregistered, "PutBooksHandler")
	}
...
func (o *LibraryAPI) initHandlerCache() {
	...
	o.handlers["DELETE"]["/books/{bookID}"] = NewDeleteBooksBookID(o.context, o.DeleteBooksBookIDHandler)
	...
	o.handlers["GET"]["/books/{bookID}"] = NewGetBooksBookID(o.context, o.GetBooksBookIDHandler)
	...
	o.handlers["PUT"]["/books"] = NewPutBooks(o.context, o.PutBooksHandler)
